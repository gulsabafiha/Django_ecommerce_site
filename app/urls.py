...
urlpatterns = [
    ...
    path('passwordchange/',auth_views.PasswordChangeView.as_view(template_name='app/passwordchange.html',form_class=MyPschangeForm,success_url='/passchangdone/'),name="passwordchange"),
    path('passchangdone/',auth_views.PasswordChangeDoneView.as_view(template_name='app/passchangdone.html'),name='passchangdone'),
